...
<html class="no-js"  lang="en">
	...
	<body>
							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">		  
									<ul class="nav navbar-nav navbar-right">
										...
										<li>
											<button class="book-btn"><a href="login.php">book now</a></button>
										</li><!--/.project-btn--> 
									</ul>
								</div><!-- /.navbar-collapse -->
							</div><!-- /.main-menu-->
		...
		<!--travel-box start-->
		<section  class="travel-box" id="travel-box">
        	<div class="container">
        		<div class="row">
        			<div class="col-md-12">
						  		...
						  		<div class="row">
						  			...
						  			<div class="col-md-6">
						  				<div class="filtr-item">
											<img src="https://media.gettyimages.com/id/1187147151/photo/local-and-tourists-enjoying-shanghais-famous-traditional-architecture-of-yuyuan-garden-in.jpg?s=612x612&w=0&k=20&c=wU9LZwYPzEPiwO4sZvC1ajE23VPb7hNaemB4YjVMoMY=" alt="portfolio image"/>
											<div class="item-title">
												<a href="hotelbookin.php">
													china
												</a>
						  			...
						  			<div class="col-md-6">
						  				<div class="filtr-item">
											<img src="https://images.pexels.com/photos/14237625/pexels-photo-14237625.jpeg?auto=compress&cs=tinysrgb&w=600" alt="portfolio image"/>
											<div class="item-title">
											    <a href="hotelbookin.php">
													venuzuala
												</a>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<img src="assets/images/gallary/brazil.jpg" alt="portfolio image"/>
											<div class="item-title">
											    <a href="hotelbookin.php">
													brazil
												</a>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<img src="assets/images/gallary/aus.jpg" alt="portfolio image"/>
											<div class="item-title">
											    <a href="hotelbookin.php">
													australia 
												</a>
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											<img src="assets/images/gallary/netherland.jpg" alt="portfolio image"/>
											<div class="item-title">
											    <a href="hotelbookin.php">
													netharland
												</a>
						  			...
						  			<div class="col-md-8">
						  				<div class="filtr-item">
											<img src="assets/images/gallary/Turkeya.jpg" alt="portfolio image"/>
											<div class="item-title">
											    <a href="hotelbookin.php">
													turkey
												</a>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="dicount-offer-content text-center">
							<h2>Join with us within 21 January, 2022 and get upto 40% Discount</h2>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="assets/images/packages/italy.jpg" alt="package-place">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="assets/images/packages/englend.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="assets/images/packages/France.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="assets/images/packages/india.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="assets/images/packages/spain.jpg" alt="package-place">
								<div class="single-package-item-txt">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="assets/images/packages/Thailand.jpg" alt="package-place">
								<div class="single-package-item-txt">
					...
					<div class="home1-testm item">
						<div class="home1-testm-single text-center">
							<div class="home1-testm-img">
								<img src="assets/images/client/user.jpg" alt="img"/>
							</div><!--/.home1-testm-img-->
							...
							<div class="row">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										...
										<div class="thumbnail-img">
											<img src="assets/images/blog/news1.jpg" alt="blog-img">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2022</span></h2>
										<div class="thumbnail-img">
											<img src="assets/images/blog/news2.jpg" alt="blog-img">
											<div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2022</span></h2>
										<div class="thumbnail-img">
											<img src="assets/images/blog/news3.jpg" alt="blog-img">
											<div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
						...
						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
							<div class="custom-input-group">
								<form  action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
								    ...
								    <!-- <button class="appsLand-btn subscribe-btn" name="subscribe">Subscribe</button> -->
									<input type="submit" class="appsLand-btn subscribe-btn" name="submit" value="subscribe">
								</form>
			...
			<div class="container">
				...
				<div class="foot-icons ">
					<ul class="footer-social-links list-inline list-unstyled">
		                <li><a href="https://www.facebook.com/people/Mayra-Singh/100078409896906/" target="_blank" class="foot-icon-bg-1"><i class="fa fa-facebook"></i></a></li>
		                <li><a href="#" target="_blank" class="foot-icon-bg-2"><i class="fa fa-twitter"></i></a></li>
		                <li><a href="https://www.instagram.com/invites/contact/?i=x9wj3buvbx3m&utm_content=nxl74e1" target="_blank" class="foot-icon-bg-3"><i class="fa fa-instagram"></i></a></li>
		        	</ul>
